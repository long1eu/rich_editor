...
import 'package:rich_editor/editor/src/services/rich_text_parser.dart';
import 'package:rich_editor/editor/src/services/text_input.dart';
import 'package:rich_editor/editor/src/widgets/text_selection.dart';
...
class RichTextEditingController extends ValueNotifier<RichTextEditingValue> {
  ...
  set selection(TextSelection newSelection) {
    if (newSelection.start > textSpan.length ||
        newSelection.end > textSpan.length)
...
class RichEditableTextState extends State<RichEditableText>
  ...
  void initState() {
    ...
    _editingValue = _editingValue.copyWith(
        value: _editingValue.value.copyWith(style: _styleController.value));
  }
...
// Calculate the new scroll offset so the cursor remains visible.
  ...
  void _handleSelectionChanged(
    ...
    if (widget.selectionControls != null) {
      ...
      if (_editingValue.value.isNotEmpty || longPress)
  ...
  void _updateStyleForPosition(TextSelection selection) {
    ...
    if (selection.baseOffset == selection.extentOffset) {
      ...
      _styleController.value = TextStyle.empty;
    }
  }
