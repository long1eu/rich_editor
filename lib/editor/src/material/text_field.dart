...
import 'package:rich_editor/editor/src/cupertino/text_selection.dart';
import 'package:flutter_logger/flutter_logger.dart';
import 'package:rich_editor/editor/src/material/text_selection.dart';
      ...
      child = new AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget child) {
          return new InputDecorator(
            ...
            isEmpty: controller.value.value.isEmpty,
            child: child,
          );
        },
        child: child,
